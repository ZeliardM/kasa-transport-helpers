...
P384_M_HEX = (
    "030ff0895ae5ebf6187080a82d82b42e2765e3b2f8749c7e05eba366434b363d3dc36f15314739074d"
    "2eb8613fceec2853"
)
P384_N_HEX = (
    "02c72cf2e390853a1c1c4ad816a62fd15824f56078918f43f922ca21518f9c543bb252c5490214cf9a"
    "a3f0baab4b665c10"
)

P521_M_HEX = (
    "02003f06f38131b2ba2600791e82488e8d20ab889af753a41806c5db18d37d85608cfae06b82e4a72cd744"
    "c719193562a653ea1f119eef9356907edc9b56979962d7aa"
)
P521_N_HEX = (
    "0200c7924b9ec017f3094562894336a53c50167ba8c5963876880542bc669e494b2532d76c5b53dfb349fdf"
    "69154b9e0048c58a42e8ed04cef052a3bc349d95575cd25"
)
...
def get_curve_and_points(suite_type: int) -> tuple[Curve, bytes, bytes]:
    ...
    try:
        ...
        raise KeyError(f"Unsupported SPAKE2+ suite type: {suite_type}") from None
